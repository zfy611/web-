if (function(t, e) {
        ...
        function d(t, e, n) {
            if (At(t)) {
                ...
                if (s[a]) {
                    ...
                    }(n || (delete s[a].data, c(s[a]))) && (r ? ht.cleanData([t], !0) : ut.deleteExpando || s != s.window ? delete s[a] : s[a] = void 0)
                }
            }
        }
        ...
        function R(t, e) {
            var n, i, o, r, s;
            for (n in t)
                if (i = ht.camelCase(n), o = e[i], r = t[n], ht.isArray(r) && (o = r[1], r = t[n] = r[0]), n !== i && (t[i] = r, delete t[n]), (s = ht.cssHooks[i]) && "expand" in s) {
